...
const Color _kCtaGradientStart = Color(0xFFFFFFFF);
const Color _kCtaGradientEnd = Color(0xFFFFFFFF);
const Color _kCtaTextColor = Color(0xFF7A3FF2);
const Color _kLinkColor = Color(0xFFFFFFFF);
const Color _kFeatureIconColor = Color(0xFFFFFFFF);
